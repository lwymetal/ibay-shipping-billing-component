...
exports.config = {
   ...
   */
  app_name: ['iBay shipping/billing component'],
  /**
   * The user's license key. Must be set by per-app configuration file.
   *
   * @env NEW_RELIC_LICENSE_KEY
   */
  license_key: 'e32ca53def3d9453545f7cc3dbe205675a990a64',
  /**
   *
   ...
   */
  attributes_enabled: false, // TODO: Remove this option in Agent v5.
  /**
